...
- Launch your terminal and paste the following command: `git clone https://github.com/BrianMwevi/galleria.git`
- Change directory to galleria `cd galleria`
...
If you find any bug, open an issue [here](https://github.com/BrianMwevi/galleria/issues) by including your search query and the expected result.
...
[Read More](https://github.com/BrianMwevi/galleria/blob/develop/LICENSE)


[Go Back To Top](#galleria)
